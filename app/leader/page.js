          ...
          {step === 'intro' && (
            <div style={{ textAlign: 'center' }}>
              ...
              <div style={{ fontSize: 13, color: '#666', lineHeight: 1.65, marginBottom: 24 }}>
                Five quick questions. Your answers help us understand if Mosen is actually useful for leaders navigating change.
              </div>
          ...
          {step === 'done' && (
            <div style={{ textAlign: 'center' }}>
              ...
              <div style={{ fontSize: 13, color: '#666', lineHeight: 1.65, marginBottom: 22 }}>
                {saving ? '' : 'Your feedback goes directly into our research. It genuinely helps us understand what works.'}
              </div>
              {!saving && (
                <button onClick={onClose}
