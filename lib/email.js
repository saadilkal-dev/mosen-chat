...
export function buildSynthesisNudgeEmail({ leaderName, initiativeTitle, nudgeMessage, initiativeUrl }) {
  return {
    subject: `Mosen: A signal from your team on ${initiativeTitle}`,
    html: `<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8" />
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#FFFFFF;border-radius:16px;border:1px solid #EBEBEA;padding:40px;">
        <tr><td>
          ...
          <p style="font-size:16px;color:#1A1A18;margin:0 0 20px;">Hi ${leaderName},</p>

          <p style="font-size:13px;font-weight:600;color:#534AB7;text-transform:uppercase;letter-spacing:0.5px;margin:0 0 12px;">
            A signal from your team
          </p>

          <div style="background:#F6F5FF;border-left:3px solid #534AB7;border-radius:4px;padding:20px 24px;margin:0 0 24px;">
            <p style="font-size:15px;color:#1A1A18;line-height:1.7;margin:0;white-space:pre-wrap;">${nudgeMessage}</p>
          </div>

          <p style="font-size:14px;color:#888;line-height:1.6;margin:0 0 24px;">
            This is anonymized — no names, no guessing. Just a human signal worth paying attention to.
          </p>

          <a href="${initiativeUrl}" style="display:inline-block;background:#534AB7;color:#FFFFFF;text-decoration:none;font-size:15px;font-weight:600;padding:14px 28px;border-radius:10px;">
            Open Initiative
          </a>

          <p style="font-size:12px;color:#BBBBBB;margin:28px 0 0;line-height:1.5;">
            Mosen surfaces employee insights only when someone explicitly consents. This signal came from your team — treat it as a gift.
          </p>
        </td></tr>
      </table>
    </td></tr>
