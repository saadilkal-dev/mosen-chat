...
export function employeeSystemPrompt({ employee_name, initiative_title, week_number, last_contact_date } = {}) {
...
Initiative: ${initiative_title || "Not yet defined"}
Week: ${week_number || 1}
Last contact: ${last_contact_date || "First contact"}`;
}
...
FORMAT GUIDELINES:
- Use clear sections with headers (use markdown formatting)
- Be specific to this initiative, not generic
- Include concrete language, not placeholder text
- Keep it actionable — someone should be able to use this document today
