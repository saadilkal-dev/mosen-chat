...
const RAG_TOP_K = 5            // was 10 — fewer chunks = fewer tokens
const RAG_THRESHOLD = 0.55     // slightly stricter = higher quality hits only
const MAX_CONTEXT_CHARS = 2500 // was 4000 — keeps RAG injection ~625 tokens
